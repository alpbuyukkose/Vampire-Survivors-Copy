...
public class PlayerStatController : MonoBehaviour
{
    ...
    public void UpdateDisplay()
    {
        ...
        {
            UIController.instance.moveSpeedUpgradeDisplay.UpgradeDisplay(moveSpeed[moveSpeedLevel + 1].cost, moveSpeed[moveSpeedLevel].value, moveSpeed[moveSpeedLevel + 1].value);
        }
        else
        {
        ...
        {
            UIController.instance.healthUpgradeDisplay.UpgradeDisplay(health[healthLevel + 1].cost, health[healthLevel].value, health[healthLevel + 1].value);
        }
        else
        {
        ...
        {
            UIController.instance.pickupRangeUpgradeDisplay.UpgradeDisplay(pickupRange[pickupRangeLevel + 1].cost, pickupRange[pickupRangeLevel].value, pickupRange[pickupRangeLevel + 1].value);
        }
        else
        {
        ...
        {
            UIController.instance.maxWeaponsUpgradeDisplay.UpgradeDisplay(maxWeapons[maxWeaponsLevel + 1].cost, maxWeapons[maxWeaponsLevel].value, maxWeapons[maxWeaponsLevel + 1].value);
        }
        else
        {
